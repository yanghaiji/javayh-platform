...
public class QRCodeGenerator {
	...
	private static String encode(String content, String imgPath, String destPath,
			boolean needCompress) throws Exception {
		BufferedImage image = QRCodeGenerator.createImage(content, imgPath, needCompress);
		mkdirs(destPath);
	 ...
	 * @return void
	 */
	public static void outputQRCode(String text, String logoPath,
	 ...
	 * "https://blog.csdn.net/weixin_38937840"; //这里设置自定义网站url String logoPath =
	 * "C:\\Users\\haiyang\\Desktop\\MyQRCode.png"; String destPath =
	 * "C:\\Users\\haiyang\\Desktop\\"; System.out.println(QRCodeGenerator.encode(text,

...
public class SensitiveWordFilter {
    ...
    public String filterInfo(String str) {
        ...
        Map<Integer, Integer> hash = new ConcurrentHashMap<Integer, Integer>(onWriteArraySet.size());
        String temp;
        ...
        try {
            read = new InputStreamReader(
                    Objects.requireNonNull(
                            SensitiveWordFilter.class.getClassLoader().getResourceAsStream(fileName)), encoding);

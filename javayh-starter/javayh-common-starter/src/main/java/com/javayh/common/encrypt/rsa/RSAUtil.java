...
public class RSAUtil {
    ...
    public static RSAPublicKey getRSAPublicKey(String hexModulus, String hexPublicExponent) {
        if (isBlank(hexModulus) || isBlank(hexPublicExponent)) {
            log.error("hexModulus and hexPublicExponent cannot be empty. return null(RSAPublicKey).");
            return null;
        }
        byte[] modulus = null;
        ...
        try {
            ...
            log.error("hexModulus or hexPublicExponent value is invalid. return null(RSAPublicKey). {}",ex);
    ...
    public static RSAPrivateKey getRSAPrivateKey(String hexModulus, String hexPrivateExponent) {
        ...
        try {
            ...
            System.out.println();
           log.error("hexModulus or hexPrivateExponent value is invalid. return null(RSAPrivateKey). {}",ex);
        }

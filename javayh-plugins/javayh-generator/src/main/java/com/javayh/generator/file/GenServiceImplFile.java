	...
	public void generate(){
		...
		packageName =
				GenerateConfig.BASE_PACKAGE_NAME + "." + GenerateConfig.PROJECT_NAME + "." + gMain.getModelName() +
						"." + GenerateConfig.IMPL_NAME;
		className = NameUtils.formatClassName(gMain.getTableName()) + GenerateConfig.IMPL_FILENAME;
...
//		content.append("import com.github.pagehelper.PageInfo;").append(lineSeparator);
        ...
        content.append("\t").append("public ").append("PageQuery<"+beanFile.getClassName()+">").append(" findByPage (")
                .append(beanDTOFile.getClassName() + " "+ StringUtil.toFirstUpCase(beanDTOFile.getClassName()))
                .append(")").append("{").append(lineSeparator);
        content.append("\t\t").append("PageHelper.startPage(").append(StringUtil.toFirstUpCase(beanDTOFile.getClassName())+".getPageNo()").append(","+StringUtil.toFirstUpCase(beanDTOFile.getClassName())+".getPageSize());").append(lineSeparator);
        String beanName = StringUtil.toFirstUpCase(beanFile.getClassName())+"List";
        content.append("\t\t").append("List<" + beanFile.getClassName()+">"+ " "+beanName).append(" = ").append(mapperName).append(".findByPage(").append(StringUtil.toFirstUpCase(beanDTOFile.getClassName())).append(");").append(lineSeparator);
        content.append("\t\t").append("PageQuery page = ").append("PageQuery.ofPage("+beanName+");").append(lineSeparator);
        content.append("\t\t").append("return ").append("page;").append(lineSeparator);
        content.append("\t").append("}").append(lineSeparator);
        content.append(lineSeparator);

//		content.append("\t").append("public ").append("PageInfo<"+beanFile.getClassName()+">").append(" findByPage (")
...
//		String beanName = StringUtil.toFirstUpCase(beanFile.getClassName())+"List";
//		content.append("\t\t").append("List<" + beanFile.getClassName()+">"+ " "+beanName).append(" = ").append(mapperName).append(".findByPage(").append(StringUtil.toFirstUpCase(beanFile.getClassName())).append(");").append(lineSeparator);
//		content.append("\t\t").append("PageInfo<"+beanFile.getClassName()+"> pageInfo = ").append("new PageInfo<>("+beanName+");").append(lineSeparator);
//		content.append("\t\t").append("return ").append("pageInfo;").append(lineSeparator);
//		content.append("\t").append("}").append(lineSeparator);
//		content.append(lineSeparator);
        ...
        content.append("\t").append("@Override").append("\r");
		content.append("\t").append("public ").append(beanFile.getClassName()).append(" findById(Integer ").append(gMain.getStructureList().get(0).getFieldName()).append(")").append("{").append(lineSeparator);
        ...
        content.append("\t").append("@Override").append("\r");
		content.append("\t").append("public int deleteById(Integer ").append(gMain.getStructureList().get(0).getFieldName()).append(")").append("{").append(lineSeparator);
	 ...
	 * @param mapperFile
	 */
	public GenServiceImplFile(GenMain gMain, GenBeanFile beanFile,  GenBeanDTOFile beanDTOFile,
                              GenMapperJavaFile mapperFile,GenIServiceFile serviceFile) {
		super();
		this.gMain = gMain;

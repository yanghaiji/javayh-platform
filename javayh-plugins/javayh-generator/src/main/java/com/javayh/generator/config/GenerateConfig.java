...
public class GenerateConfig {
    ...
    //java代码路径的前缀
    public final static String basepathPrefix = Property + PropertyOther+"\\src\\main\\java\\";
    //xml文件路径的前缀
    public final static String xmlbasepathPrefix = Property +  PropertyOther+"\\src\\main\\resources\\";

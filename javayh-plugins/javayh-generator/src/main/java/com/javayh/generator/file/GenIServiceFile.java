...
public class GenIServiceFile {
	...
	public void generate() {
		...
		packageName = GenerateConfig.BASE_PACKAGE_NAME + "." + GenerateConfig.PROJECT_NAME
				+ "." + gMain.getModelName() + "." + GenerateConfig.SERVICE_NAME;
		className = GenerateConfig.SERVICE1_FILENAME
				+ NameUtils.formatClassName(gMain.getTableName())
				+ GenerateConfig.SERVICE2_FILENAME;
	...
	private String genContent() {
		...
		content.append("\t").append("PageQuery<").append(beanFile.getClassName())
				.append("> findByPage (")
				.append(beanDtoFile.getClassName() + " "
						+ StringUtil.toFirstUpCase(beanDtoFile.getClassName()))
				.append(")").append(";").append(lineSeparator);
		content.append(lineSeparator);
		// content.append("\t").append("PageInfo<").append(beanFile.getClassName()).append(">
		// findByPage (")
	 ...
	 * @param beanFile
	 */
	public GenIServiceFile(GenMain gMain, GenBeanFile beanFile,

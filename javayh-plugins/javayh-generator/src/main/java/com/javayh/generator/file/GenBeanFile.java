...
public class GenBeanFile {
	...
	public void generate(){
		//包名
		packageName =
				GenerateConfig.BASE_PACKAGE_NAME + "." + GenerateConfig.PROJECT_NAME + "." + gMain.getModelName() + "." + GenerateConfig.POJO_BO_NAME;
...
//		content.append("import com.javayh.common.entity.BaseEntity;").append(lineSeparator);
		content.append(lineSeparator);
		...
		content.append("public class ").append(className)./*append(" extends BaseEntity").*/append(" implements java.io.Serializable").append("{").append(lineSeparator);
